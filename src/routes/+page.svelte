	...
	<div class="hero-container relative h-screen overflow-hidden">
		...
		<div class="relative mx-auto flex h-full max-w-7xl items-center justify-center px-6 lg:px-8">
			<div class="mx-auto max-w-4xl text-center">
				<h1
					class="hero-title mb-6 flex flex-col items-center justify-center gap-4 text-center text-5xl font-bold tracking-tight text-stone-900 sm:flex-row sm:text-6xl"
				>
					Better
