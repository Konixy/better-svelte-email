...
- `tailwindConfig?` — Partial Tailwind config. Use it to extend the default theme, add plugins, or tweak core options.
...
- `options?` — Object with the same shape as `RenderOptions` (see below).
