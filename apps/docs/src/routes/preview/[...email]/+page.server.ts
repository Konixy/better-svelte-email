...
import type { PreviewData } from '@better-svelte-email/preview';
import type { RequestEvent } from '@sveltejs/kit';
import { Renderer, type TailwindConfig } from '@better-svelte-email/server';
import prettier from 'prettier/standalone';
import parserHtml from 'prettier/parser-html';
import { pixelBasedPreset } from '@better-svelte-email/server';
import fs from 'fs';
